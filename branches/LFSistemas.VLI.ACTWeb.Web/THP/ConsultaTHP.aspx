                                ...
                                <asp:Repeater ID="RepeaterItens" runat="server">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 05%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="LinkButton1" Text="Parada Incons." /></th>
                                    ...
                                    <ItemTemplate>
                                        <tr class="status-<%# Eval("Cor") %>">
                                            ...
                                            <td style="width: 05%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89); "> 
                                                <img src="../img/icone_alerta.png"  style="visibility: <%# Eval("Parada_Incons") %>;" />
                                            </td>
