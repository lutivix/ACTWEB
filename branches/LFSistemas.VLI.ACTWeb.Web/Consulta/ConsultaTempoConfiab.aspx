<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="ConsultaTempoConfiab.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Consulta.ConsultaTempoConfiab" %>
            ...
            <td style="width: 79%; text-align: left;">
                <div class="alert alert-success">
                    <h2>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Tempo Confiabilidade" Font-Size="20px" Style="color: rgb(0, 100, 0);" /></h2>
                </div>
            </td>
