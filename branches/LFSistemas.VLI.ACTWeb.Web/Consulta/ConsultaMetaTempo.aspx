<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="ConsultaMetaTempo.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Consulta.ConsultaMetaTempo" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="Abas/MetaTempo.ascx" TagName="Dados" TagPrefix="ucAbas" %>
            ...
            <td style="width: 79%; text-align: left;">
                <div class="alert alert-success">
                    <h2>
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Meta Tempo" Font-Size="20px" Style="color: rgb(0, 100, 0);" /></h2>
                </div>
            </td>
                ...
                <table style="width: 100%; padding-left: 1em; padding-right: 1em;">
                    ...
                    <tr>
                        <td style="width: 100%; padding-top: 1em;" colspan="3">
                            ...
                            <asp:LinkButton runat="server" ID="lnkExportar" CssClass="btn btn-default" OnClick="lnkExportar_Click" ToolTip="Exporta Metas de Tempo." Width="150"><i class="fa fa-table"></i>&nbsp;Exportar</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 05%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="lnkIdLocal" Text="ID" /></th>
                                                    <th style="width: 20%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="lnkLocalidade" Text="Localidade" /></th>
                                                    <th style="width: 10%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                     ...
                                                     <th style="width: 45%; text-align: center; font-size: 12pt;"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr>
                                            <td style="width: 10px; height: 20px; text-align: center; border-right: 1px solid rgb(0, 72, 89); ">
                                                <asp:LinkButton runat="server" ID="lnkAcao" OnClick="lnkAcao_Click" CommandArgument='<%# Eval("Localidade_ID")%>' Height="20px" ><i class="fa fa-search-plus status-branco" style="font-size: 1.5em;" ></i></asp:LinkButton>
                                            </td>
                                            <td style="width: 20%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Corredor_DS") %>"><%# Eval("Corredor_DS")%></td>
                                            <td style="width: 05%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Localidade_ID") %>"><%# Eval("Localidade_ID")%></td>
                                            <td style="width: 20%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Localidade_DS") %>"><%# Eval("Localidade_DS")%></td>
                                            <td style="width: 10%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Tempo_Min_QT") %>"><%# Eval("Tempo_Min_QT")%></td>
