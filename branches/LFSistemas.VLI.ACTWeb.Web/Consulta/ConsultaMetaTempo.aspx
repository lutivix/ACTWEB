                                        ...
                                        <asp:Repeater ID="RepeaterItens" runat="server">
                                            <HeaderTemplate>
                                                <table class="table table-hover table-curved pro-table">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 10px; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; height: 20px; font-size: 1.2em; text-align: left; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Corredor_DS") %>"><%# Eval("Corredor_DS")%></td>
                                                    <td style="width: 10%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Localidade_ID") %>"><%# Eval("Localidade_ID")%></td>
                                                    <td style="width: 40%; height: 20px; font-size: 1.2em; text-align: left; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Localidade_DS") %>"><%# Eval("Localidade_DS")%></td>
                                                    <td style="width: 10%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle;" title="<%# Eval("Tempo_Min_QT") %>"><%# Eval("Tempo_Min_QT")%></td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                </tbody>
