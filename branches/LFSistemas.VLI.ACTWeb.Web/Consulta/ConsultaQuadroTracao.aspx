                                ...
                                <asp:Repeater ID="RepeaterItens" runat="server">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                     ...
                                                     <th style="width: 1%; text-align: center; font-size: 12pt;"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="width: 10%; height: 20px; font-size: 1.2em; text-align: center; vertical-align: middle; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Capac_Tracao_QT") %>"><%# Eval("Capac_Tracao_QT")%></td>
