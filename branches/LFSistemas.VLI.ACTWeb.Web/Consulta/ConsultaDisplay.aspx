            ...
            <td style="width: 79%; text-align: left;">
                <div class="alert alert-success">
                    <h2><asp:Image runat="server" ImageUrl="/img/apoio-b.png" />
                        <asp:Label ID="Label1" runat="server" Text="Consulta de Frases do Display " Font-Size="20px" Style="color: rgb(0, 100, 0);" /></h2>
                </div>
            </td>
        ...
        <div class="well well-sm">
            ...
            <div id="filtros" style="margin-top: 1%; margin-left: 1%; margin-right: 1%; margin-bottom: 1%; text-align: left;">
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 90%;">
                            <label for="matricula">Mensagem:</label>
                                        ...
                                        <table class="table table-hover table-curved pro-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 80%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="lnkMensagem" OnClick="lnkMensagem_Click" Text="Mensagem" /></th>
                                                    <th style="width: 13%; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="LnkData" OnClick="LnkData_Click" Text="Data" /></th>
                                                    <th style="width: 4%; text-align: center; font-size: 12pt; ">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td style="width: 2%; text-align: center; border-right: 1px solid rgb(0, 72, 89);">
                                                <asp:LinkButton runat="server" ID="lnkAlteraDisplay" OnClick="lnkAlteraDisplay_Click" CommandArgument='<%# Eval("DisplayID")%>'><span><i class="fa fa-search-plus"></i></span></asp:LinkButton></td>
                                            <td style="width: 80%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Mensagem")%>"><%# Eval("Mensagem")%> </td>
                                            <td style="width: 13%; text-align: center; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Data")%>"><%# Eval("Data") %> </td>
                                            <td class="ativo-<%#  Eval("Ativo").ToString().Substring(0, 1) %>" style="width: 4%; text-align: center;" title="<%# Eval("Ativo")%>"><%# Eval("Ativo")%> </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </tbody>
