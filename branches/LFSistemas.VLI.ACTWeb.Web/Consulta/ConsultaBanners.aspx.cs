...
{
    public partial class ConsultaBanners : System.Web.UI.Page
    {
        #region [ PROPRIEDADES ]

        public List<Banner> itens { get; set; }
        ...
        protected void lnkAlteraBanners_Click(object sender, EventArgs e)
        {
            LinkButton btn = (LinkButton)(sender);
            string id = btn.CommandArgument;

            Response.Redirect("/Cadastro/Cadastro_Banners.aspx?di=" + Uteis.Criptografar(id, "a#3G6**@") + "&lu=" + Uteis.Criptografar(ViewState["ulNome"].ToString().ToLower(), "a#3G6**@") + "&mu=" + Uteis.Criptografar(ViewState["uMatricula"].ToString().ToLower(), "a#3G6**@") + "&pu=" + Uteis.Criptografar(ViewState["uPerfil"].ToString().ToLower(), "a#3G6**@") + "&mm=" + Uteis.Criptografar(ViewState["ulMaleta"].ToString().ToLower(), "a#3G6**@"));
        }
        ...
        {
            Response.Redirect("/Cadastro/Cadastro_Banners.aspx?di=" + Uteis.Criptografar("", "a#3G6**@") + "&lu=" + Uteis.Criptografar(ViewState["ulNome"].ToString().ToLower(), "a#3G6**@") + "&mu=" + Uteis.Criptografar(ViewState["uMatricula"].ToString().ToLower(), "a#3G6**@") + "&pu=" + Uteis.Criptografar(ViewState["uPerfil"].ToString().ToLower(), "a#3G6**@") + "&mm=" + Uteis.Criptografar(ViewState["ulMaleta"].ToString().ToLower(), "a#3G6**@"));
        }
        ...
        protected void Pesquisar(string ordenacao, Navigation navigation)
        {
            ...
            itens = pesquisar.ObterPorFiltro(new Banner()
            {
