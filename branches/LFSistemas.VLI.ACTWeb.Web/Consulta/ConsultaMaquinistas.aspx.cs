...
{
    public partial class ConsultaMaquinistas : System.Web.UI.Page
    {
        #region [ PROPRIEDADES ]
        ...
        {
            abaDados.Voltar += new Abas.Maquinista.VoltarEventHandler(Voltar);
        ...
        protected void lnkExportar_Click(object sender, EventArgs e)
        {
            ...
            if (itens.Count > 0)
            {
                sb.AppendLine("MATRICULA;NOME;SEDE");


                foreach (var Maq in itens)
                {
                    sb.AppendLine(string.Format("{0};{1};{2}", Maq.Maquinista_MT,Maq.Maquinista_NM,Maq.Estacao_Sede_ID));
                }
            }
            else
            {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=maquinistas.csv");
