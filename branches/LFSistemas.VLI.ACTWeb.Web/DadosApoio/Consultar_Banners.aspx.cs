...
{
    public partial class Consultar_Banners : System.Web.UI.Page
    {
        #region [ ATRIBUTOS ]
        ...
        protected void lnkNovo_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/DadosApoio/Manter/Banners.aspx?di=" + Uteis.Criptografar("", "a#3G6**@"));

        }
        protected void lnkLimpar_Click(object sender, EventArgs e)
        {
            txtFiltroArquivo.Text = string.Empty;
            Pesquisar(null, Navigation.None);
        }
        ...
        protected void Pesquisar(string ordenacao, Navigation navigation)
        {
            ...
            itens = acao.ObterPorFiltro(new Banner()
            {
