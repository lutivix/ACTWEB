<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="Perfis.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.DadosApoio.Manter.Perfis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    <script type="text/javascript">
        function validaFormulario() {
            ...
            if (document.getElementById("<%=txtDadosDescricao.ClientID%>").value == '') {
                msg += " o Descricao. \n";
                item += "<%=txtDadosDescricao.ClientID%>";
                retorno = false;
            }
