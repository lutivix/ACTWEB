...
namespace LFSistemas.VLI.ACTWeb.Web
{
    public partial class ACTWEB : System.Web.UI.MasterPage
    {
        ...
        {
            Response.Write("<script> window.open('http://172.21.26.51:8090/e-graph-server/', 'scrollbars=yes, resizable=yes, status=no, toolbar=no, location=no, durectirues=no, top=0, left=0' ); </script>");//CXXX - Hel MA Novo link Gráfico 24/07/2023
