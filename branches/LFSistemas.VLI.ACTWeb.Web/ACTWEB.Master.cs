    ...
    public partial class ACTWEB : System.Web.UI.MasterPage
    {
        ...
        protected void ControleDeNivelAcesso()
        {
            ...
            if (usuario.Perfil_ID == "2") // Perfil: PADRÃO - PAD
            {
                ...
                sub_macros_macrofrota.Visible = sub_dadosapoio_plus.Visible = sub_baixada.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
            if (usuario.Perfil_ID == "3") // Perfil: CENTRO DE APOIO AO TREM - CAT
            {
                ...
                mnRelatorios.Visible = sub_macros_macrofrota.Visible = sub_dadosapoio_plus.Visible = sub_baixada.Visible = mnPgof.Visible = false;
            }
            if (usuario.Perfil_ID == "4") // Perfil: CENTRO DE TOMADA DE DECISÃO / HELPDESK - CTD
            {
                ...
                mnRelatorios.Visible = sub_macros_macrofrota.Visible = sub_dadosapoio_plus.Visible = sub_baixada.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
            if (usuario.Perfil_ID == "5") // Perfil: INSPETOR - INSP
            {
                ...
                sub_relatorio_MACROS.Visible = sub_dadosapoio_meta_pctm.Visible = sub_relatorio_PCTM.Visible = sub_dadosapoio_logs.Visible =
                mnUsuarios.Visible = mnRelatorios.Visible = sub_macros_macrofrota.Visible = sub_dadosapoio_plus.Visible = sub_baixada.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
            ...
            if (usuario.Perfil_ID == "7") // Perfil: OPERADOR ELETROELETRÔNICO - OP ELE
            {
                ...
                sub_dadosapoio_plus.Visible = sub_baixada.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
            ...
            if (usuario.Perfil_ID == "11") // Perfil: ADMINISTRADOR ELETROELETRÔNICO - ADM ELE
            {
                ...
                sub_dadosapoio_downloads.Visible = sub_relatorio_MACROS.Visible = sub_dadosapoio_meta_pctm.Visible = sub_relatorio_PCTM.Visible =
                sub_dadosapoio_logs.Visible = mnLocomotivas.Visible = sub_macros_macrofrota.Visible = sub_dadosapoio_plus.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
            if (usuario.Perfil_ID == "12") // Perfil: OPERADOR VITORIA MINAS - OP VM
            {
                ...
                mnRelatorios.Visible = sub_baixada.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
            ...
            if (usuario.Perfil_ID == "14") // CENTRO DE APOIO AO TREM - ADM - ADM CAT
            {
                ...
                sub_dadosapoio_banners.Visible = sub_baixada.Visible = mnSistema.Visible = mnPgof.Visible = false;
            }
