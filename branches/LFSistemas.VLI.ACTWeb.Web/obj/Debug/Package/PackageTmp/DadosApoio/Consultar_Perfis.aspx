<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="Consultar_Perfis.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.DadosApoio.Consultar_Perfis" %>
                        ...
                        <tr>
                            <td>
                                <asp:Repeater ID="RepeaterItens" runat="server">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th style="width: 05%; text-align: center; font-size: 12pt; background-color: rgb(55, 119, 188); border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="lnkID" OnClick="lnkID_Click" Text="Código" ForeColor="White" />
                                                    </th>
                                                    <th style="width: 70%; text-align: center; font-size: 12pt; background-color: rgb(55, 119, 188); border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="lnkDescricao" OnClick="lnkDescricao_Click" Text="Descrição" ForeColor="White" />
                                                    </th>
                                                    <th style="width: 20%; text-align: center; font-size: 12pt; background-color: rgb(55, 119, 188); border-right: 1px solid rgb(0, 72, 89);">
                                                        <asp:LinkButton runat="server" ID="lnkAbreviado" OnClick="lnkAbreviado_Click" Text="Sigla" ForeColor="White" />
                                                    </th>
                                                    <th style="width: 05%; text-align: center; font-size: 12pt; background-color: rgb(55, 119, 188);">
                                    ...
                                    <ItemTemplate>
                                        <tr style="background-color: #eee; cursor: pointer;" onclick="javascript:window.location='/DadosApoio/Manter/Perfis.aspx?di=<%# LFSistemas.VLI.ACTWeb.Entities.Uteis.Criptografar(Eval("Perfil_ID").ToString(), "a#3G6**@") %>'">
                                            <td style="width: 05%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Perfil_ID")%>"><%# Eval("Perfil_ID")%> </td>
                                            <td style="width: 70%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Descricao")%>"><%# Eval("Descricao")%> </td>
                                            <td style="width: 20%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Abreviado")%>"><%# Eval("Abreviado")%> </td>
                                            <td class="ativo-<%# Eval("Ativo").ToString().Substring(0, 1) %>" style="width: 05%; text-align: center;" title="<%# Eval("Ativo")%>"><%# Eval("Ativo")%> </td>
                                        </tr>
                                    </ItemTemplate>
                                    <AlternatingItemTemplate>
                                        <tr style="background-color: #fff; cursor: pointer;" onclick="javascript:window.location='/DadosApoio/Manter/Perfis.aspx?di=<%# LFSistemas.VLI.ACTWeb.Entities.Uteis.Criptografar(Eval("Perfil_ID").ToString(), "a#3G6**@") %>'">
                                            <td style="width: 05%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Perfil_ID")%>"><%# Eval("Perfil_ID")%> </td>
                                            <td style="width: 70%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Descricao")%>"><%# Eval("Descricao")%> </td>
                                            <td style="width: 20%; text-align: left; border-right: 1px solid rgb(0, 72, 89);" title="<%# Eval("Abreviado")%>"><%# Eval("Abreviado")%> </td>
                                            <td class="ativo-<%# Eval("Ativo").ToString().Substring(0, 1) %>" style="width: 05%; text-align: center;" title="<%# Eval("Ativo")%>"><%# Eval("Ativo")%> </td>
