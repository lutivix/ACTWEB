<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PainelGen.CarneiroMontesClaros.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Painel.WebForm1" %>
...
<head id="Head1" runat="server">
    <title>ACTWEB - Painel General Carneiro - Montes Claros  </title>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin: 2%;">
                ...
                <tr>
                    <td style="width: 79%;">
                        <div class="alert alert-success">
                            <h2><asp:Label ID="Label1" runat="server" Text="Role o scroll do mouse para aumentar ou diminuir o tamanho da imagem, ou clique nos ícones abaixo." Font-Size="20px" style="color: rgb(0, 100, 0);" />&nbsp;</h2>
                        </div>
            ...
            <div id="container_image">
                <img src="http://actweb1/actweb/ctdpainel/imagem/GeneralCarneiroMontesClaros.jpeg" id="image" style="width: 100%" />
            </div>
        </div>
        <br />
