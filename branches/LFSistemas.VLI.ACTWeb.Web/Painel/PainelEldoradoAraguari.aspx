<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PainelEldoradoAraguari.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Painel.PainelEldoradoAraguari" %>
...
<head id="Head1" runat="server">
    <title>ACTWEB - Painel Eldorado Araguari</title>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin: 2%;">
            ...
            <div id="container_image">
                <img src="http://actweb1/actweb/ctdpainel/imagem/EldoradoAraguari.jpeg" id="image" style="width: 100%" />
            </div>
        </div>
        <br />
