<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PainelCCO.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Painel.PainelCCO" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin: 2%;">
                ...
                <tr>
                    <td style="width: 79%;">
                        <div class="alert alert-success">
                            <h2><asp:Label ID="Label1" runat="server" Text="Role o scroll do mouse para aumentar ou diminuir o tamanho da imagem, ou clique nos ícones abaixo. Atualizado em: " Font-Size="20px" style="color: rgb(0, 100, 0);" />&nbsp;
                                <font color="red"><asp:Label runat="server" ID="lblUltimaAtualizacao" Font-Size="20px" style="color: rgb(204, 102, 51);" /></font></h2>
                        </div>
                        <a id="mais" href="#" title="Seta pra cima Zoom +" class="mais tamanho"><img src="../img/zoom_in-a.png" width="50" /></a>
                        <a id="menos" href="#" title="Seta pra baixo Zoom -" class="menos tamanho"><img src="../img/zoom_out-a.png" width="50" /></a>
                    </td>
            ...
            <div id="container_image">
                <img src="../imagens_paineis/painel_CCO/01_Painel_Full.jpg" id="image" style="width: 460%"  />
            </div>
        </div>
        <br />
