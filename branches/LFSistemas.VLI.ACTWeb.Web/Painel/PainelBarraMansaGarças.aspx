<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PainelBarraMansaGarças.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Painel.PainelBarraMansaGarças" %>
...
<head id="Head1" runat="server">
    <title>ACTWEB - Painel Barra Mansa Garças </title>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin: 2%;">
            ...
            <div id="container_image">
                <img src="http://actweb1/actweb/ctdpainel/imagem/BarraMansaGarcasMinas.jpeg" id="image" style="width: 100%" />
            </div>
        </div>
        <br />
