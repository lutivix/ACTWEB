<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="Cadastro_QuadroTracao.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Cadastro.Cadastro_QuadroTracao" %>
            ...
            <td style="width: 79%; text-align: left;">
                <div class="alert alert-success">
                    <h2>
                        ...
                        <asp:Label ID="lblTitulo" runat="server" Text="Quadro de Traçao" Font-Size="20px" Style="color: rgb(0, 100, 0);" CssClass="menu-item-icon menu-icon-radio" /></h2>
                </div>
            </td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    ...
    <div class="well well-sm">
        <table style="width: 100%;">
            <tr>
                <td style="width: 10%;">
                    <label for="hora_inicio">Locomotiva:</label>
                    <asp:TextBox ID="txtDadosHoras" Text="GT3" runat="server" Width="90%" CssClass="form-control" MaxLength="10"  />
                </td>      
                <td style="width: 10%;">
                    <label for="hora_inicio">Estacao Ini:</label>
                    <asp:TextBox ID="TextBox1" Text="ZHF" runat="server" Width="90%" CssClass="form-control" MaxLength="10" />
                </td>      
                <td style="width: 10%;">
                    <label for="hora_inicio">Estacao Fim:</label>
                    <asp:TextBox ID="TextBox3" Text="ZUL" runat="server" Width="90%" CssClass="form-control" MaxLength="10"  />
                </td>      
                <td style="width: 10%;">
                    <label for="hora_inicio">Capacidade (t):</label>
                    <asp:TextBox ID="TextBox2" Text="0" runat="server" Width="90%" CssClass="form-control" MaxLength="10" onkeypress="return PermiteSomenteNumeros(event);" />
                </td>      
