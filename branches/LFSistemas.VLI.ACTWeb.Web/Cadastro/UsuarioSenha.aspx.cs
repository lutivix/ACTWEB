...
namespace LFSistemas.VLI.ACTWeb.Web.Cadastro
{
    public partial class UsuarioSenha : System.Web.UI.Page
    {
        ...
        protected void ButtonSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (usuarioController.AtualizarSenha(usuario, ulMatricula))
            {
                limparCampos();
                if (Flag == "alterasenha")
        ...
        protected void ButtonCancelar_Click(object sender, EventArgs e)
        {
            //if (txtMatricula.Text != null && ddlPerfil != null)
            {
                if (this.Flag == "consulta" || this.Flag == "novousuario")
                    Response.Redirect("/Consulta/UsuarioSenha.aspx?lu=" + Uteis.Criptografar(ulNome.ToLower(), "a#3G6**@") + "&mu=" + Uteis.Criptografar(ulMatricula.ToLower(), "a#3G6**@") + "&pu=" + Uteis.Criptografar(ulPerfil.ToLower(), "a#3G6**@") + "&mm=" + Uteis.Criptografar(ulMaleta.ToLower(), "a#3G6**@").ToString());
                else
        ...
        protected void Controle(string flag)
        {
            switch (flag)
            {
                case "consulta":
                    ...
                    txtMatricula.Enabled = false;
                    txtNome.Enabled = txtSenha.Enabled = true;
                ...
                case "alterasenha":
                    ...
                    txtMatricula.Enabled = txtNome.Enabled = false;
                ...
                case "dadosusuario":
                    ...
                    txtMatricula.Enabled = txtNome.Enabled = txtSenha.Enabled = false;
