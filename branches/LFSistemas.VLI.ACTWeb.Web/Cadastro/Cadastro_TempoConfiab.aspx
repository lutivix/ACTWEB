<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="Cadastro_TempoConfiab.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Cadastro.Cadastro_TempoConfiab" %>
            ...
            <td style="width: 79%; text-align: left;">
                <div class="alert alert-success">
                    <h2>
                        ...
                        <asp:Label ID="lblTitulo" runat="server" Text="Tempo Confiabilidade" Font-Size="20px" Style="color: rgb(0, 100, 0);" CssClass="menu-item-icon menu-icon-radio" /></h2>
                </div>
            </td>
    ...
    <div class="well well-sm">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="width: 10%;">
                    <label for="hora_inicio">Tempo (h):</label>
                    <asp:TextBox ID="txtDadosHoras" runat="server" Width="70%" CssClass="form-control" MaxLength="3" onkeypress="return PermiteSomenteNumeros(event);" />
                </td>
                <td style="width: 67%;" />
            </tr>
            <tr>
