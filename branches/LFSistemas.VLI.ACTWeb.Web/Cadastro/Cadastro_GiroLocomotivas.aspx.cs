...
{
    public partial class Cadastro_GiroLocomotivas : System.Web.UI.Page
    {
        #region [ ATRIBUTOS ]
        ...
        {
            Response.Write("<script> window.location='/Consulta/ConsultarGiroLocomotivas.aspx'</script>");
        }
        ...
        protected void ControlarBarraComandos(string status)
        {
            ...
            {
                lblTitulo.Text = "Giro de Locomotivas - Cadastrando.";
            ...
            {
                lblTitulo.Text = "Giro de Locomotivas - Alterando.";
                lnkSalvar.Enabled = true;
                lnkSalvar.CssClass = "btn btn-success";
                lnkCalncelar.Enabled = true;
                lnkCalncelar.CssClass = "btn btn-info";
