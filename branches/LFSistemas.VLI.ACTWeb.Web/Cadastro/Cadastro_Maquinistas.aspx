<%@ Page Title="" Language="C#" MasterPageFile="~/ACTWEB.Master" AutoEventWireup="true" CodeBehind="Cadastro_Maquinistas.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Cadastro.Cadastro_Maquinistas" %>
            ...
            <td style="width: 79%; text-align: left;">
                <div class="alert alert-success">
                    <h2>
                        ...
                        <asp:Label ID="lblTitulo" runat="server" Text="Maquinistas" Font-Size="20px" Style="color: rgb(0, 100, 0);" CssClass="menu-item-icon menu-icon-radio" /></h2>
                </div>
            </td>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
    ...
    <div class="well well-sm">
        <table style="width: 100%;">
            <tr>
                <td style="width: 10%;">
                    <label for="hora_inicio">Matricula:</label>
                    <asp:TextBox ID="txtDadosHoras" runat="server" Width="93%" CssClass="form-control" MaxLength="3" onkeypress="return PermiteSomenteNumeros(event);" />
                </td>
                <td style="width: 30%;">
                    <label for="hora_inicio">Nome</label>
                    <asp:TextBox ID="txtDadosMinutos" runat="server" Width="98%" CssClass="form-control" MaxLength="3" onkeypress="return PermiteSomenteNumeros(event);" />
                </td>
