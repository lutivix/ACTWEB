...
namespace LFSistemas.VLI.ACTWeb.DataAccessObjects
{
    public class InterdicaoDAO
    {
        ...
        public bool ExisteLDLAtivaNaSecao(double SB)
        {
            #region [ PROPRIEDADES ]
        ...
        private Interdicao PreencherPropriedadesInterdicaoPorID(OracleDataReader reader)
        {
            ...
            if (!reader.IsDBNull(37)) item.Responsavel2_Nome = reader.GetString(37);//C1448
            if (!reader.IsDBNull(38)) item.Telefone_resp2 = reader.GetString(38);//C1448
