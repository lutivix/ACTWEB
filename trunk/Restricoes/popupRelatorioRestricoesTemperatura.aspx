<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="popupRelatorioRestricoesTemperatura.aspx.cs" Inherits="LFSistemas.VLI.ACTWeb.Web.Restricoes.popupRelatorioRestricoesTemperatura" %>

<!DOCTYPE html>

<html lang="pt-br" style="width: 100%; height: 100%; overflow: scroll;">
<head runat="server">
    <title>ACTWEB - Relatório de Restrições de Temperatura</title>
                            ...
                            <tr>
                                <td>
                                    <asp:Panel ID="Panel1" runat="server">
                                        <asp:Repeater ID="rptListaRestricoesTemperatura" runat="server">
                                            <HeaderTemplate>
                                                <table class="table table-hover table-curved pro-table " id="macros">
                                                    <thead>
                                                        <tr style="vertical-align: bottom;">
                                                            ...
                                                            <th style="background-color: white; text-align: center; font-size: 12pt; border-right: 1px solid rgb(0, 72, 89);"><a href="#">Data Inicio</a></th>
                                            ...
                                            <ItemTemplate>
                                                <tr style="font-size: 9px;" class="situacao-<%# Eval("Situacao")%>">
                                                    ...
                                                    <td style="text-align: center;" title="><%# Eval ("Observacao")%>"><%# Eval ("Observacao")%></td>
                                                </tr>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                </tbody>
